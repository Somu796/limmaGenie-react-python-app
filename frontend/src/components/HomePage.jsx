  ...
  return (
    <>
      <main className="mt-16 max-w-3xl mx-auto text-center">
        <h1 className="text-6xl font-bold mb-6 bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent leading-tight font-raisin">
          limmaGenie
        </h1>
      ...
      <div className="container mx-auto max-w-4xl pt-10">
        <MessageInput handleMessages={props.handleMessages} />
      </div>
    </>
  );
}
